...
## Files included:
- assets 
  - Folder containing images used in website
- app.py
  - Main application code, run this python file to host website locally
- below.csv
  - Cleaned sidewalk 311 service requests data
  - Original data: 311 Service Requests https://data.boston.gov/dataset/311-service-requests
- sidewalk comparison.xlsx
  - Data used to build Sidewalk Accessibility map
  - Original data: Sidewalk Inventory https://data.boston.gov/dataset/sidewalk-inventory
- requirements.txt
